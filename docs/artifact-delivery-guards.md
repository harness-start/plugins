...
渲染依赖属于 artifact 工程：PptxGenJS、Satori/resvg、Remotion、React/Vivliostyle、Tone.js、Tonal、Playwright 及其版本应由项目 `package-lock.json` 固定。音乐插件提供受控的浏览器离线渲染 wrapper；其他守卫只提供约束和 writer，不代替项目构建脚本。
