...
if [ -z "$DWG_PLUGIN_ROOT" ]; then
  for DWG_CANDIDATE in \
    "${CODEX_HOME:-$HOME/.codex}"/plugins/cache/harness-start/software-debugging/* \
    "$HOME/.claude/plugins/cache/"*/software-debugging \
    /marketplace/plugins/software-debugging
  do
