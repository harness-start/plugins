...
// plugins/video-project-delivery-guard/src/entries/cli/project-admit.ts
import { createHash } from "node:crypto";
import { copyFile, lstat, mkdir, readFile, rename, unlink } from "node:fs/promises";
import { basename, dirname, extname, isAbsolute, join, relative, resolve } from "node:path";
var RUN_SCHEMA = "video-project-delivery-guard/external-run/v1";
var ADMISSION_SCHEMA = "video-project-delivery-guard/admission/v1";
