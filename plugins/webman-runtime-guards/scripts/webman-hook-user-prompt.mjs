#!/usr/bin/env node
/**
 * webman-runtime-guards UserPromptSubmit entry.
 *
 * Injects webman environment facts once per session when the prompt signals
 * a webman project. Fail-open: any error exits 0 silently.
 */
