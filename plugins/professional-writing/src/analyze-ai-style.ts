...
function lineKind(line: string): "blank" | "heading" | "list" | "fence" | "prose" {
...
export function analyzeAiStyle(markdown: string): AnalyzerFinding[] {
...
export function formatAnalyzerReport(findings: AnalyzerFinding[]): string {
