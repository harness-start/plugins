...
import { createPrintReceipt, validatePrintModel, validatePrintReceipt } from "../lib/contract.mjs";
...
main().catch((error) => { process.stderr.write(`[print-project-release] ${error.message}\n`); process.exitCode = 2; });
