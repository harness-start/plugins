...
var PLAN_SCHEMA = "poster-project-delivery-guard/plan/v2";
var ART_DIRECTION_SCHEMA = "poster-project-delivery-guard/art-direction/v1";
var SKILL_COMPOSITION_SCHEMA = "poster-project-delivery-guard/skill-composition/v1";
var ASSET_MANIFEST_SCHEMA = "poster-project-delivery-guard/assets/v2";
var DESIGN_SYSTEM_SCHEMA = "poster-project-delivery-guard/design-system/v1";
var PROJECT_SCHEMA = "poster-project-delivery-guard/project/v2";
var VARIANT_MANIFEST_SCHEMA = "poster-project-delivery-guard/variant-manifest/v2";
var LAYER_MANIFEST_SCHEMA = "poster-project-delivery-guard/layer-manifest/v2";
var RENDER_EVIDENCE_SCHEMA = "poster-project-delivery-guard/render/v1";
var PROBE_EVIDENCE_SCHEMA = "poster-project-delivery-guard/probe/v1";
var ACCESSIBILITY_EVIDENCE_SCHEMA = "poster-project-delivery-guard/accessibility/v2";
var REVIEW_SCHEMA = "poster-project-delivery-guard/review/v2";
var RELEASE_MANIFEST_SCHEMA = "poster-project-delivery-guard/release-manifest/v2";
...
// plugins/poster-project-delivery-guard/src/lib/writer.ts
...
async function withWriterJournal(root, capability, callback, grant = {}) {
  ...
  try {
    await handle.writeFile(`${JSON.stringify({ schemaVersion: 2, plugin: "poster-project-delivery-guard", operation: capability, artifactId: basename2(root), ...sessionMetadata(capability, grant) })}
`);
    await handle.sync();
  } finally {
    await handle.close();
