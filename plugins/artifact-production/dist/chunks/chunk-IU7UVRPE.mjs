...
// plugins/artifact-production/src/domains/video/lib/capability.ts
...
// plugins/artifact-production/src/domains/video/lib/contract.ts
...
var VIDEO_REVIEW_SCHEMA = "video-production/video-review/v3";
var REVIEW_INPUT_SCHEMA = "video-production/review-input/v3";
...
var DIRECTION_SCHEMA = "video-production/direction/v2";
var SCRIPT_SCHEMA = "video-production/script/v1";
var STORYBOARD_SCHEMA = "video-production/storyboard/v3";
...
function validateReviewEvidence(model, findings) {
  ...
  const core = isObject(direction?.communicationCore) ? direction.communicationCore : void 0;
