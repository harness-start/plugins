...
import { renderProject } from "../../../src/domains/music/lib/renderer.js";
import { analyzePcm16Wav } from "../../../src/domains/music/lib/wav.js";
...
test("writes current-digest stem and mix WAV files from the browser render boundary", async () => {
  ...
  try {
    ...
    const { computeMusicSubjectDigest } = await import("../../../src/domains/music/lib/contract.js");
