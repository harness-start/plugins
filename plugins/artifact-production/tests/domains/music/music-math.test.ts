...
import { PROFILE_WEIGHTS, euclideanPattern, optimizeComposition } from "../../../src/domains/music/lib/music-math.js";
...
test("keeps published profile assets identical to executable weights", async () => {
  for (const [name, weights] of Object.entries(PROFILE_WEIGHTS)) {
    const fileUrl = new URL(`../../../skills/music-project-authoring/assets/profiles/${name}.json`, import.meta.url);
