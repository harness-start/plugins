...
import {
  ...
  masterSubjectDigest,
  reviewArtifactPaths,
} from "../../../../src/domains/logo/lib/contract.js";
...
export function validLogoModel({ artifactId = "orbit-logo", stage = "release" } = {}) {
  ...
  const files = {
    ...
    "plan.color-system.json": JSON.stringify({ schema: COLOR_SYSTEM_SCHEMA, artifactId, core: "brandPrimary", tokens: { brandPrimary: "3457D5", canvas: "FFFFFF", text: "111827", reverse: "FFFFFF", accent: "F3A712" }, structuralRoles: { brand: "brandPrimary", canvas: "canvas", text: "text", reverse: "reverse" }, scenarios: [{ id: "light", core: "brandPrimary", roles: { brand: "brandPrimary", canvas: "canvas", text: "text", reverse: "reverse" } }, { id: "dark", core: "brandPrimary", roles: { brand: "brandPrimary", canvas: "text", text: "reverse", reverse: "reverse" } }], contrastPairs: [{ foreground: "text", background: "canvas", minimum: 4.5 }], prohibitedCombinations: [{ foreground: "accent", background: "canvas", reason: "accent is not approved for small copy" }] }),
