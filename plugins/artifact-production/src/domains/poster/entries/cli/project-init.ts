...
const PROFILE_DEFAULTS: Record<
  PosterProfile,
  {
    ...
    visualCenter: string;
    dominantAxis: string;
    massToVoidTarget: { min: number; max: number };
  }
> = {
  "regional-culture": {
    width: 1200,
    height: 1600,
    concept:
      "Translate one specific regional mechanism into a contemporary visual structure.",
    visualCenter:
      "One culturally grounded structure with controlled typography.",
  ...
  mondo: {
    ...
    height: 1920,
    concept:
      "Condense the subject into one original symbolic image with a limited screen-print palette.",
  ...
  editorial: {
    ...
    height: 1600,
    concept:
      "Build a type-led editorial page whose hierarchy follows the brief rather than a fixed template.",
  ...
  academic: {
    ...
    height: 1200,
    concept:
      "Compress the research story into a distance-readable digital overview.",
    visualCenter:
      "One large explanatory figure with sparse supporting evidence.",
  ...
  custom: {
    ...
    height: 1600,
    concept:
      "Create an original digital poster from one explicit communication objective.",
...
async function main() {
  ...
  const profile = process.argv[4] as PosterProfile;
  ...
  const files: Record<string, string> = {
    ...
    "src/variants/001-main/layers/001-background-base.tsx":
    ...
    "src/variants/001-main/layers/002-title-primary.tsx":
    ...
    "src/variants/001-main/layers/003-body-supporting.tsx":
