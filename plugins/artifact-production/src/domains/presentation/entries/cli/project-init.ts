...
async function main() {
  ...
  const files: Record<string, string> = {
    ...
    "plan.storyboard.json": `${JSON.stringify({ schema: STORYBOARD_SCHEMA, slides: [{ index: 1, id: "opening", displayTitle: "TODO", role: "opening", visual: { type: "hero", variant: "statement" }, assertion: "This deck leads to one explicit decision.", narrativeJob: "state the decision", transition: "establish the question before supporting evidence", coreContribution: "States the exact retell target." }] }, null, 2)}\n`,
    ...
    "design.system.json": `${JSON.stringify({ schema: DESIGN_SYSTEM_SCHEMA, colors: { roles: { canvas: "FFFFFF", surface: "F5F7FA", textPrimary: "17202A", textSecondary: "4B5563", accent: "0067C5", success: "237B4B", warning: "9A6700", error: "B42318" }, charts: { categorical: ["0067C5", "D97706", "237B4B", "7C3AED"] } }, typography: { roles: { display: { fontFamily: "Arial", fontSizePt: 36, lineSpacingMultiple: 1.1, charSpacingPt: 0, maxLines: 1, scriptPolicy: "mixed" }, title: { fontFamily: "Arial", fontSizePt: 30, lineSpacingMultiple: 1.15, charSpacingPt: 0, maxLines: 1, scriptPolicy: "mixed" }, section: { fontFamily: "Arial", fontSizePt: 24, lineSpacingMultiple: 1.2, charSpacingPt: 0, maxLines: 3, scriptPolicy: "mixed" }, body: { fontFamily: "Arial", fontSizePt: 22, lineSpacingMultiple: 1.35, charSpacingPt: 0, maxLines: 6, scriptPolicy: "mixed" }, caption: { fontFamily: "Arial", fontSizePt: 14, lineSpacingMultiple: 1.3, charSpacingPt: 0, maxLines: 3, scriptPolicy: "mixed" }, numeric: { fontFamily: "Arial", fontSizePt: 28, lineSpacingMultiple: 1.1, charSpacingPt: 0, maxLines: 2, scriptPolicy: "latin" } }, fallbacks: ["Arial", "Calibri"] }, spacing: { pageMarginIn: 0.5, baseUnitIn: 0.1, blockGapIn: 0.3, paragraphGapIn: 0.18 }, shape: { radiusIn: 0.08 }, antiPatterns: ["brief-leakage", "sentence-headlines", "repeated-layout", "decorative-connector", "color-only-encoding", "text-only-slide"] }, null, 2)}\n`,
