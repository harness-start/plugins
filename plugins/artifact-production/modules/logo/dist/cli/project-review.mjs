...
import {
  ...
  sessionMetadata,
  withWriterJournal
} from "../chunks/chunk-PIRK3OBQ.mjs";
import {
...
// plugins/artifact-production/modules/logo/src/entries/cli/project-review.ts
import { createHash as createHash2 } from "node:crypto";
import { readFile } from "node:fs/promises";
import { isAbsolute as isAbsolute2, relative as relative2, resolve as resolve2 } from "node:path";

// plugins/artifact-production/modules/logo/src/lib/codex-review-identity.ts
