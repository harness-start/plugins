...
```bash
node "${PLUGIN_ROOT}/dist/cli/harness.mjs music advice" "artifacts/music/<id>" "/absolute/path/to/advice.json"
```
...
```bash
node "${PLUGIN_ROOT}/dist/cli/harness.mjs music reference" \
  "artifacts/music/<id>" \
...
```bash
node "${PLUGIN_ROOT}/dist/cli/harness.mjs music init" "artifacts/music/<id>" --install-browser
```
...
```bash
node "${PLUGIN_ROOT}/dist/cli/harness.mjs music lint" "artifacts/music/<id>"
```

Generate the current symbolic score and metrics:

```bash
node "${PLUGIN_ROOT}/dist/cli/harness.mjs music optimize" "artifacts/music/<id>"
```
...
```bash
node "${PLUGIN_ROOT}/dist/cli/harness.mjs music render" "artifacts/music/<id>"
```
...
```bash
node "${PLUGIN_ROOT}/dist/cli/harness.mjs music stage" "artifacts/music/<id>" release
node "${PLUGIN_ROOT}/dist/cli/harness.mjs music release" "artifacts/music/<id>"
```
