...
export const MUSIC_ENGINE = "music-production@0.4.0";
export const PLAN_SCHEMA = "music-production/plan/v1";
export const LEGACY_BRIEF_SCHEMA = "music-production/brief/v1";
export const BRIEF_SCHEMA = "music-production/brief/v2";
export const DIRECTION_SCHEMA = "music-production/direction/v1";
export const ARRANGEMENT_SCHEMA = "music-production/arrangement/v1";
export const LEGACY_SKILL_COMPOSITION_SCHEMA = "music-production/skill-composition/v1";
export const SKILL_COMPOSITION_SCHEMA = "music-production/skill-composition/v2";
export const SKILL_ADVICE_INPUT_SCHEMA = "music-production/advice-input/v1";
export const SKILL_ADVICE_SCHEMA = "music-production/advice/v1";
export const REFERENCE_SOURCES_INPUT_SCHEMA = "music-production/reference-sources-input/v1";
export const REFERENCE_PROFILE_INPUT_SCHEMA = "music-production/reference-profile-input/v1";
export const REFERENCE_PROFILE_SCHEMA = "music-production/reference-profile/v1";
export const PREVIEW_SCHEMA = "music-production/preview/v1";
export const LEGACY_REVIEW_INPUT_SCHEMA = "music-production/review-input/v1";
export const REVIEW_INPUT_SCHEMA = "music-production/review-input/v2";
export const LEGACY_REVIEW_SCHEMA = "music-production/review/v1";
export const REVIEW_SCHEMA = "music-production/review/v2";
    ...
    if (worker?.status === "used") {
      if (expected.artifactKind === "reference-profile") {
        ...
        try {
          ...
          if (!advice || Object.hasOwn(advice, "revision") || advice.schema !== SKILL_ADVICE_SCHEMA || advice.skillName !== expected.name
