...
} from "./chunk-IQLIQEGH.mjs";

// plugins/pptx-project-delivery-guard/src/lib/capability.ts
...
async function issueWriterCapability({ root: rawRoot, capability, argv, subjectDigest, sessionId, triggerFrom }) {
  ...
  const grant = {
    schema: "pptx-project-delivery-guard/writer-capability/v1",
    id: randomUUID(),
    capability,
    root,
