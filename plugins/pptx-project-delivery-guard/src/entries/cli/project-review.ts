...
async function main() {
  ...
  if (payload.schema !== "pptx-project-delivery-guard/review-input/v1" || payload.artifactId !== model.artifactId || payload.subjectDigest !== computePptxSubjectDigest(model) || payload.verdict !== "pass") throw new Error("REVIEW_INPUT_INVALID");
