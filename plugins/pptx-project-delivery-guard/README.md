...
`pptx-project-delivery-guard` 为从零制作的 16:9、原生可编辑 PPTX 提供一条受保护的交付链。插件内置 `pptx-deck-authoring` 编排 Skill 与 `pptx-deck-review` 独立审查 Skill，并将 source、design、render、probe、review、release 六阶段落实为可检查的工程合同。
