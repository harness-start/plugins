...
export function computePptxSubjectDigest(model) {
...
export function createPptxReceipt(model, stage = "release") {
...
export function validatePptxReceipt(model, stage = "release") {
...
export function validatePptxModel(model, { stage = "source" } = {}) {
  const findings = [];
...
export async function loadPptxProject(projectRoot, limits = {}) {
