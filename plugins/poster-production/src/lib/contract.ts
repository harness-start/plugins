...
export const ART_DIRECTION_SCHEMA = "poster-production/art-direction/v1";
export const SKILL_COMPOSITION_SCHEMA = "poster-production/skill-composition/v1";
export const ASSET_MANIFEST_SCHEMA = "poster-production/assets/v2";
export const DESIGN_SYSTEM_SCHEMA = "poster-production/design-system/v1";
...
export const ACCESSIBILITY_EVIDENCE_SCHEMA = "poster-production/accessibility/v2";
