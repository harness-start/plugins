#!/usr/bin/env node
// harness-source-hash: sha256:86576f4e39fd57ebc060a41d6942a80b50a9c142952542fe8783539765c34f3b
import {
  issueWriterCapability
} from "../chunks/chunk-CCE4SJOH.mjs";
import {
  ...
  validatePosterModel
} from "../chunks/chunk-DPAJ7XQZ.mjs";
...
function wrapperInvocation(words, cwd, workspaceRoot) {
  ...
  if (dirname3(projectRoot) !== resolve3(workspaceRoot, "artifacts", "poster") || !/^[a-z0-9]+(?:-[a-z0-9]+)*$/u.test(basename2(projectRoot))) return null;
...
var initDigest = (root) => createHash2("sha256").update(`poster-init:${resolve4(root)}`).digest("hex");
