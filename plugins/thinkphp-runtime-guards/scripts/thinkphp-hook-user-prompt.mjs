#!/usr/bin/env node
/**
 * thinkphp-runtime-guards UserPromptSubmit entry.
 *
 * Injects thinkphp environment facts once per session when the prompt signals
 * a thinkphp project. Fail-open: any error exits 0 silently.
 */
