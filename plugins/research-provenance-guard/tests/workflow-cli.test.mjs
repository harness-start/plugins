...
import { findActiveWorkflow, readWorkflowFile, workflowPath } from "../scripts/lib/workflow-fs.mjs";

const CLI = fileURLToPath(new URL("../scripts/research-workflow.mjs", import.meta.url));
