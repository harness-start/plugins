...
import { evaluateStop } from "../src/entries/hooks/research-provenance-guard.js";
...
function runHook(mode, event, dataRoot) {
  const script = fileURLToPath(new URL("../dist/hooks/research-provenance-guard.mjs", import.meta.url));
