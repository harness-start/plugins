...
const SESSION_CONTEXT = [
  ...
  "Do not start such tasks by invoking standalone firecrawl or research skills, or arxiv-search. Use them only as phase workers under the orchestrator (discover / subagent technique).",
