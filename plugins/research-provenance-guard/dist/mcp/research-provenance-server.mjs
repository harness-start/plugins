...
// plugins/research-provenance-guard/src/lib/server/research-service.ts
import { randomBytes } from "node:crypto";
import { mkdir, readFile, readdir, realpath, rename, rm, stat, writeFile } from "node:fs/promises";
import { dirname, isAbsolute, join, relative, resolve } from "node:path";
import { spawn } from "node:child_process";

// plugins/research-provenance-guard/src/lib/server/safe-fetch.ts
...
`);
  ...
  async begin(args) {
    ...
    await mkdir(join(this.dataRoot, "research-provenance-guard", "runs", runId, "events"), { recursive: true, mode: 448 });
