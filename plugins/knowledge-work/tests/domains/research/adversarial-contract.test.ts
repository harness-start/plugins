...
import { parseTrailer } from "../../../src/domains/research/lib/seal-validator.js";
...
test("URL captures use injected bounded transport and private artifacts are mode 0600", async () => {
  ...
  const content = join(dataRoot, "evidence-based-research", "runs", service.run.run_id, "sources", `${source.source_id}.txt`);
