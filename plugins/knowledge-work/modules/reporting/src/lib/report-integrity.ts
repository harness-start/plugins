...
export const SEAL_PREFIX = "<!-- work-reporting:sha256:";
const SEAL_PATTERN = /^<!-- work-reporting:sha256:([a-f0-9]{64}) -->$/gmu;
export const CHAIN_V2_PREFIX = "<!-- work-reporting:chain-v2:";
const CHAIN_V2_PATTERN = /^<!-- work-reporting:chain-v2:prev-length=(\d+);prev=([a-f0-9]{64});sha256=([a-f0-9]{64}) -->$/gmu;
