...
import {
  ...
  workflowPath,
  writeWorkflow
} from "./chunk-NWS65JED.mjs";
import {
  isRecord
} from "./chunk-TMBNPHXI.mjs";

// plugins/knowledge-work/src/domains/research/entries/cli/research-workflow.ts
...
function cmdBriefWrite(cwd, options) {
  ...
  if (options["non-goals"] !== void 0) workflow.non_goals = String(options["non-goals"]);
  if (options.decision !== void 0) workflow.decision = String(options.decision);
