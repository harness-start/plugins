import { PROFILE_IDS, PROFILES, type ProfileId } from "./profiles.js";

export type LanguageIntent = {
  preferredProfile: ProfileId | null;
...
function mentionedProfiles(prompt: string): ProfileId[] {
...
export function classifyLanguageIntent(prompt: unknown): LanguageIntent {
