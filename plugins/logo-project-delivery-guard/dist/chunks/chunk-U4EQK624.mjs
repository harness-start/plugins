...
} from "./chunk-7TWYATJQ.mjs";

// plugins/logo-project-delivery-guard/src/lib/capability.ts
...
async function issueWriterCapability({ root: rawRoot, capability, argv, subjectDigest, sessionId, triggerFrom }) {
  ...
  const grant = {
    schema: "logo-project-delivery-guard/writer-capability/v1",
    id: randomUUID(),
    capability,
    root,
