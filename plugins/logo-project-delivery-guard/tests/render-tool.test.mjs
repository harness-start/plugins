...
import { validateLogoReceipt } from "../scripts/lib/contract.mjs";
import { loadLogoProject } from "../scripts/lib/project.mjs";
import { isGeneratedPath, RENDER_FIXTURE_SCRIPT, validLogoModel, writeModel } from "./helpers/logo-fixture.mjs";

const RENDER_ENTRY = fileURLToPath(new URL("../scripts/tools/project-render.mjs", import.meta.url));
const RELEASE_ENTRY = fileURLToPath(new URL("../scripts/tools/project-release.mjs", import.meta.url));
