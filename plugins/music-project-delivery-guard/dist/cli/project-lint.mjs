...
import {
  ...
  optimizeComposition
} from "../chunks/chunk-KMGPFDGW.mjs";
import {
  collectMusicModel
...
// plugins/music-project-delivery-guard/src/entries/cli/project-lint.ts
import { createRequire } from "node:module";
import { join, resolve } from "node:path";
import { pathToFileURL } from "node:url";

// plugins/music-project-delivery-guard/src/lib/eslint/local-rules/music-ownership.ts
...
// plugins/music-project-delivery-guard/src/lib/eslint/preset.ts
var preset_default = [{
  files: ["src/**/*.mjs"],
