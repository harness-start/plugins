...
import { renderProject } from "../src/lib/renderer.js";
import { analyzePcm16Wav } from "../src/lib/wav.js";
...
test("writes current-digest stem and mix WAV files from the browser render boundary", async () => {
  ...
  try {
    ...
    const { computeMusicSubjectDigest } = await import("../src/lib/contract.js");
