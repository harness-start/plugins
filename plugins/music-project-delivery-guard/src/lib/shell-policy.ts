...
export function evaluateMusicShell({ command, cwd, workspaceRoot, toolDirectory }: { command: string; cwd: string; workspaceRoot: string; toolDirectory: string }): MusicShellDecision {
