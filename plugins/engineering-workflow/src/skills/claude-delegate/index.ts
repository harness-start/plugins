...
`,
  ...
  codexInterface: {
    shortDescription: "Delegate to another Claude session, then review and land",
    defaultPrompt: "Use $claude-delegate to delegate this bounded coding task to a separate Claude Code session.",
  },
  frontmatter: {
    version: "1.1.0",
    license: "MIT",
