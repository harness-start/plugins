...
node "${ACCEPT_REPO}/plugins/spec-driven-development/dist/cli/spec-driven-development-validate.mjs" validate "${ACCEPT_WORKSPACE}/.specs/001-color-label" >/dev/null
