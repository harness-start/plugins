...
// plugins/session-governance/modules/language/src/lib/intent.ts
...
// plugins/session-governance/modules/language/src/entries/hooks/language-output-hook-user-prompt.ts
async function main() {
