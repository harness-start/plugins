...
- Merge structured file access and shell command activity into the `agent-activity/v1` trail.
- Create `.agent-activity-audit/.gitignore` with `*` without creating or changing the project's root `.gitignore`.
