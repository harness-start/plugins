...
import { extractFilePaths } from "../src/entries/hooks/markdown-format-guard.js";
import {
  analyzeMarkdown,
  buildDocumentModel,
  isMarkdownPath,
  modeFor,
  resolveConfig,
} from "../src/lib/markdown-policy.js";

const ENTRY = fileURLToPath(
  new URL("../dist/hooks/markdown-format-guard.mjs", import.meta.url),
);
