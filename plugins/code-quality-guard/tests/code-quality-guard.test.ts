...
import { extractFileTargets } from "../src/entries/hooks/code-quality-post.js";

const POST_ENTRY = fileURLToPath(new URL("../dist/hooks/code-quality-post.mjs", import.meta.url));
const STOP_ENTRY = fileURLToPath(new URL("../dist/hooks/code-quality-stop.mjs", import.meta.url));
