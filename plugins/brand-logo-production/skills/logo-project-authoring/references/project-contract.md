...
Select a role-based subset from the bundled bilingual adviser registry. At most three may be `used`. Every used worker needs an admitted, digest-bound `evidence/skills/<name>.json`; skipped and unavailable workers need an honest reason.
