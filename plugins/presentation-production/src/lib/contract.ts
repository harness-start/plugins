...
export const SKILL_COMPOSITION_SCHEMA = "presentation-production/skill-composition/v1";
export const DESIGN_SYSTEM_SCHEMA = "presentation-production/design-system/v1";
export const PROJECT_SCHEMA = "presentation-production/project/v2";
export const SLIDE_MANIFEST_SCHEMA = "presentation-production/slide-manifest/v2";
export const RENDER_EVIDENCE_SCHEMA = "presentation-production/render-evidence/v1";
export const STRUCTURE_EVIDENCE_SCHEMA = "presentation-production/structure-evidence/v2";
export const DESIGN_EVIDENCE_SCHEMA = "presentation-production/design-evidence/v1";
export const ACCESSIBILITY_EVIDENCE_SCHEMA = "presentation-production/accessibility-evidence/v2";
export const REVIEW_SCHEMA = "presentation-production/review/v2";
export const RELEASE_MANIFEST_SCHEMA = "presentation-production/release-manifest/v2";
