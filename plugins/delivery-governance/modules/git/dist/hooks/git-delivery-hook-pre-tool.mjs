...
// plugins/delivery-governance/modules/git/src/checks/command-rules.ts
...
// plugins/delivery-governance/modules/git/src/checks/state-checks.ts
...
// plugins/delivery-governance/modules/git/src/entries/hooks/git-delivery-hook-pre-tool.ts
