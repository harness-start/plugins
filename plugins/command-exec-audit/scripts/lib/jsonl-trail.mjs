...
/**
 * Scan for a pending record with the given non-empty tool_use_id.
 * Does not rewrite non-last lines; used to recover started_at under parallel tools.
 */
 ...
 * Uses a process lock and re-validates the tip under the lock before rename.
...
export function rewriteTip(sessionPath, predicate, nextRecord) {
  ...
  try {
    ...
    // Re-validate tip under lock after building body.
