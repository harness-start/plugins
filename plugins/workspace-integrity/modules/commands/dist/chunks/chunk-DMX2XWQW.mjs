...
// plugins/workspace-integrity/modules/commands/src/lib/hook-io.ts
...
// plugins/workspace-integrity/modules/commands/src/lib/rule-engine.ts
import { execFileSync } from "node:child_process";
import { existsSync } from "node:fs";
import { join } from "node:path";
import { pathToFileURL } from "node:url";

// plugins/workspace-integrity/modules/commands/src/lib/builtin-rules.ts
...
// plugins/workspace-integrity/modules/commands/src/lib/sanitize-command.ts
