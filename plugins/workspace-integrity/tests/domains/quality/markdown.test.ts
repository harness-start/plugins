...
import { extractFilePaths } from "../../../src/domains/quality/entries/hooks/markdown-check.js";
import {
  analyzeMarkdown,
  buildDocumentModel,
  isMarkdownPath,
  modeFor,
  resolveConfig,
} from "../../../src/domains/quality/lib/markdown-policy.js";

const ENTRY = fileURLToPath(
  new URL("../../../dist/hooks/markdown-check.mjs", import.meta.url),
);
