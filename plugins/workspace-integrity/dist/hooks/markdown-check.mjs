...
// plugins/workspace-integrity/src/domains/quality/entries/hooks/markdown-check.ts
import { execFileSync } from "node:child_process";
import { existsSync, readFileSync, statSync } from "node:fs";
import { dirname, join, relative } from "node:path";
import { pathToFileURL } from "node:url";

// plugins/workspace-integrity/src/domains/quality/lib/markdown-policy.ts
var CHECK_NAMES = [
  "headingIncrement",
  "headingStyle",
  "headingSpace",
...
// plugins/workspace-integrity/src/entries/hooks/markdown-check.ts
await main();
