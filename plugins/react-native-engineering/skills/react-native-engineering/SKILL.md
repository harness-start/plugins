...
3. 路由社区 Skill：日常实现与性能使用 `react-native-best-practices`；导航使用 `react-navigation`；升级使用 `upgrading-react-native`。
...
- `react-native-best-practices` — https://github.com/callstackincubator/agent-skills
- `react-navigation` — https://github.com/callstackincubator/agent-skills
- `upgrading-react-native` — https://github.com/callstackincubator/agent-skills
