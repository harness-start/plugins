...
var CHAIN_V2_PREFIX = "<!-- work-report-insights:chain-v2:";
var CHAIN_V2_PATTERN = /^<!-- work-report-insights:chain-v2:prev-length=(\d+);prev=([a-f0-9]{64});sha256=([a-f0-9]{64}) -->$/gmu;
...
// plugins/work-report-insights/src/lib/report-contract.ts
...
// plugins/work-report-insights/src/lib/report-candidate.ts
