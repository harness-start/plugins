...
| `micro-drama` | 1080×1920, 30 fps, 60 s | character bible, scene continuity, dialogue and episode beat closure |

Defaults are scaffold values, not creative constraints. Change them before storyboard approval when the brief needs another duration or format.
