...
import { MUSIC_ENGINE, computeMusicSubjectDigest, createMusicReceipt, validateMusicModel, type MusicFileMap, type MusicModel, type MusicProjectConfig, type MusicQualityConfig } from "./contract.js";
...
export function validateListeningReview(review: unknown, { sourceDigest, mixSha256, releaseSessionId = process.env.AI_EXPERTS_SESSION_ID ?? "unknown" }: {
  sourceDigest: string;
  mixSha256: string;
