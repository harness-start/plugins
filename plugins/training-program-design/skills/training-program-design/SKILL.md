...
```bash
node "${PLUGIN_ROOT}/dist/cli/project-init.mjs" artifacts/training/workflow-foundations --mode design --target release
node "${PLUGIN_ROOT}/dist/cli/project-lint.mjs" artifacts/training/workflow-foundations --stage design
node "${PLUGIN_ROOT}/dist/cli/project-render.mjs" artifacts/training/workflow-foundations
node "${PLUGIN_ROOT}/dist/cli/project-review.mjs" artifacts/training/workflow-foundations /absolute/path/outside-project/review-input.json
node "${PLUGIN_ROOT}/dist/cli/project-release.mjs" artifacts/training/workflow-foundations
```
