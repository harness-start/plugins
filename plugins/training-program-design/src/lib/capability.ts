...
import { assertTrainingProjectRoot } from "./writer.js";

const TTL_MS = 30_000;
const CAPABILITY_SCHEMA = "training-program-design/writer-capability/v1";
...
const grantPath = (root: string, capability: string) => join(root, ".tmp", "training-guard", `capability.${capability}.json`);
