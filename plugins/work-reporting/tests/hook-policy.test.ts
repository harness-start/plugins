...
test("parseOfficialCommand rejects shell overrides of the host-owned plugin root", () => {
  const parsed = parseOfficialCommand('PLUGIN_ROOT=/tmp node "${PLUGIN_ROOT}/dist/cli/daily-work-report-save.mjs" --date 2026-08-10 --input /tmp/draft.md');
